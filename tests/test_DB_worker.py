...
def test_save_data_to_database(vacancy_object_1, vacancy_object_2):
    ...
    assert result_all_vacancies == [
        ("name_1", "test", 1, 2, "test", "https://test.ru"),
        ("name_2", "test", 1, 2, "test", "https://test_2.ru"),
    ]
    ...
    assert result_vacancies_with_keyword == [
        (1, "test", 1, 2, "test", "test", "test", "https://test.ru", 1),
        (2, "test", 1, 2, "test", "test", "test", "https://test_2.ru", 2),
    ]
